...
--Question3 --
--
The dataset resource:  https://www.geeksforgeeks.org/machine-learning/dataset-for-linear-regression/
This dataset was collected to explore the different factors that influence employee salary across 
various roles and background such as age, gender, education level, job title, and years of 
experience. The primary research question is How does these each factor influence an 
employee's salary, and can a predictive model be developed based on these variables? By 
looking at all these factors together, the goal is to create a model that can predict salary and 
help to understand how fair and structured salaries are across different groups of people and 
job roles. 
